...
<head>
  ...
  <title>Adarsh  InSiDe ❤️</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
  <style>
    body{
      background-image: url('https://i.postimg.cc/HsssTRYd/f6ce018e6ee24433adcea7ad1532b044.jpg.jpg');
    }
    .container{
      max-width: 300px;
...
<body>
  <header class="header mt-4">
    ...
    >3:)
<h1 class="mb-3" style="color: red"> TO 😈 ADARSH SERVER 😈
<h1 class="mb-3" style="color: blue">❤️ |===== DARK WEB 🖤</h1>
  </header>
